...
#
#  https://github.com/mohammed-abdullah/DevOps-Python-tools
#
...
# SYSTEM_TASKDEFINITIONSURI=https://dev.azure.com/mohammed-abdullah/
# SYSTEM_TEAMFOUNDATIONCOLLECTIONURI=https://dev.azure.com/mohammed-abdullah/
# SYSTEM_TEAMFOUNDATIONSERVERURI=https://dev.azure.com/mohammed-abdullah/
# TF_BUILD=True
#
is_azure_devops(){
    if is_tfs_ci; then
