...
#     git.cfgu email mu7med@outlook.com
#
...
# used in tests
function git.config.mohammed-abdullah() {
  [[ $(git.cfgu name) == "Konstantin Gredeskoul" &&
  $(git.cfgu email) == "mu7med@outlook.com" ]] && return 0
...
#
# @example
#   git clone git@github.com:mohammed-abdullah/bashmatic.git
#   cd bashmatic
#   source init.sh
#   git.open
