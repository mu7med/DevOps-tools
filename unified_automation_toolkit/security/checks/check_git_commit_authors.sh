...
check_duplicate_email_prefixes(){
    ...
    # email prefixes normalize hari.sekhon => mohammed-abdullah since email accounts like gmail treat them the same, so remember duplicates for mohammed-abdullah may include hari.sekhon
