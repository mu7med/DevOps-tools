   ...
   kustomization.yaml)  kustomize build --enable-helm
               ...
               .envrc)  direnv allow .
                 ...
                 *.d2)  if test -x "$basename"; then
                            # use its shebang line to get the settings like --theme or --layout elk eg. for github_actions_cicd.d2 in https://github.com/mohammed-abdullah/Diagrams-as-Code
                            ./"$basename"
