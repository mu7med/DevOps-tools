...
See mohammed-abdullah/Knowledge-Base Mac page for more details on Time Machine path exclusions for why this is needed:

    https://github.com/mohammed-abdullah/Knowledge-Base/blob/main/mac.md#time-machine
"
