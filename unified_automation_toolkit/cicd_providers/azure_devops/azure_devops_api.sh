...
#
#  https://azure_devops.com/mohammed-abdullah/bash-tools
#
...
# List a user or organization's Azure DevOps repos:
    ...
    ${0##*/} /mohammed-abdullah/GitHub/_apis/git/repositories  | jq .
...
# List a user or organization's Azure DevOps Pipelines:
    ...
    ${0##*/} /mohammed-abdullah/GitHub/_apis/pipelines | jq .
...
# Get a specific pipeline (has an href to the build yaml):
    ...
    ${0##*/} /mohammed-abdullah/GitHub/_apis/pipelines/1 | jq .
