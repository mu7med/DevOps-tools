...
Repo should be specified as <workspace>/<repo> using the slugs which are usually just the same as the username and repo lowercase (they're case sensitive, eg. mohammed-abdullah/devops-bash-tools)
...
${0##*/} mohammed-abdullah/devops-bash-tools    my new description
