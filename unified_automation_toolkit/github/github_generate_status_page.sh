...
Examples:
    ...
    With arguments will query those repo's README.md at the top level - if omitting the owner prefix will prepend \$GITHUB_ORGANIZATION/ or \$GITHUB_USER/
        ...
        GITHUB_USER=mohammed-abdullah ./github_generate_status_page.sh  DevOps-Python-tools  DevOps-Perl-tools SomeOtherCoolGuy/his-repo

        GITHUB_ORGANIZATION=my-org ./github_generate_status_page.sh  mohammed-abdullah/DevOps-Python-tools  some-org-repo
...
get_repos(){
    ...
    while true; do
        ...
        # eg. CURL_OPTS="-u mohammed-abdullah:$GITHUB_TOKEN" ...
        if [ -z "$(jq '.[]' <<< "$output")" ]; then
            break
...
is_owner_mohammed-abdullah(){
    shopt -s nocasematch
    [[ "$OWNER" =~ ^mohammed-abdullah$ ]]
}

if is_owner_mohammed-abdullah; then
    cat >> "$tempfile_summary" <<EOF
[![Generate README](https://github.com/mohammed-abdullah/CI-CD/actions/workflows/readme.yaml/badge.svg)](https://github.com/mohammed-abdullah/CI-CD/actions/workflows/readme.yaml)
[![pages-build-deployment](https://github.com/mohammed-abdullah/CI-CD/actions/workflows/pages/pages-build-deployment/badge.svg)](https://github.com/mohammed-abdullah/CI-CD/actions/workflows/pages/pages-build-deployment)
[![Netlify Status](https://api.netlify.com/api/v1/badges/853ef60c-c01b-4b83-99ba-8fda541f850f/deploy-status)](https://app.netlify.com/sites/mohammed-abdullah/deploys)
...
[![GitHub Last Commit](https://img.shields.io/github/last-commit/mohammed-abdullah/CI-CD?logo=github)](https://github.com/mohammed-abdullah/CI-CD/commits/master)
EOF
fi
...
if is_owner_mohammed-abdullah; then
    cat >> "$tempfile_header" <<-EOF
[![StarCharts](https://img.shields.io/badge/Star-Charts-blue?logo=github)](https://github.com/mohammed-abdullah/unified_automation_toolkit/blob/master/STARCHARTS.md)
EOF
fi
...
[![Azure DevOps Profile](https://img.shields.io/badge/Azure%20DevOps-mohammed-abdullah-0078D7?logo=azure%20devops)](https://dev.azure.com/mohammed-abdullah/GitHub)
[![GitHub Profile](https://img.shields.io/badge/GitHub-mohammed-abdullah-2088FF?logo=github)](https://github.com/mohammed-abdullah)
[![GitLab Profile](https://img.shields.io/badge/GitLab-mohammed-abdullah-FCA121?logo=gitlab)](https://gitlab.com/mohammed-abdullah)
[![BitBucket Profile](https://img.shields.io/badge/BitBucket-mohammed-abdullah-0052CC?logo=bitbucket)](https://bitbucket.org/mohammed-abdullah)
[![GitHub Pages](https://img.shields.io/badge/GitHub-Pages-2088FF?logo=github)](https://mohammed-abdullah.github.io/CI-CD/)
[![Netlify](https://img.shields.io/badge/Netlify-site-00C7B7?logo=netlify)](https://mohammed-abdullah.netlify.app/)

[![CI/CD Builds](https://img.shields.io/badge/CI%2FCD%20Builds-$num_builds-blue?logo=circleci)](https://mohammed-abdullah.github.io/CI-CD/)
...
#    cat <<EOF
#
#[git.io/hari-ci](https://git.io/hari-ci) generated by \`${0##*/}\` in [mohammed-abdullah/unified_automation_toolkit](https://github.com/mohammed-abdullah/unified_automation_toolkit)
#
#This page usually loads better on [BitBucket](https://bitbucket.org/mohammed-abdullah/ci-cd/src/master/README.md) due to less aggressive proxy timeouts cutting off badge loading than GitHub / GitLab
#
#EOF
#
#fi
