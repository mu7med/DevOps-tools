...
#  args: mohammed-abdullah/devops-bash-tools testenv haritest=stuff haritest2=stuff2
#
...
Examples:
    ...
    ${0##*/} mohammed-abdullah/unified_automation_toolkit testenv AWS_ACCESS_KEY_ID=AKIA...

    echo AWS_ACCESS_KEY_ID=AKIA... | ${0##*/} mohammed-abdullah/unified_automation_toolkit testenv

    echo AWS_ACCESS_KEY_ID=AKIA... | gh secret set -R mohammed-abdullah/unified_automation_toolkit --env testenv -f -


    Loads both AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY via stdin:

        aws_csv_creds.sh credentials_exported.csv | ${0##*/} mohammed-abdullah/unified_automation_toolkit testenv

        aws_csv_creds.sh credentials_exported.csv | gh secret set -R mohammed-abdullah/unified_automation_toolkit --env testenv -f -
