...
# Examples:
    ...
    Without arguments queries for all non-fork repos for your \$GITHUB_USER and iterate them up to $top_N to generate the page
        ...
        GITHUB_USER=mohammed-abdullah ./github_generate_status_page.sh
"
...
followers="$("$srcdir/github_api.sh" /users/mohammed-abdullah | jq -r .followers)"
...
[![GitStar Ranking Profile](https://img.shields.io/badge/GitStar%20Ranking-mohammed-abdullah-blue?logo=github)](https://gitstar-ranking.com/mohammed-abdullah)

[git.io/hari-starcharts](https://git.io/hari-starcharts) generated by \`${0##*/}\` in [mohammed-abdullah/unified_automation_toolkit](https://github.com/mohammed-abdullah/unified_automation_toolkit)
