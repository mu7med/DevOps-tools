...
#  args: /user | jq .
#  args: /users/mohammed-abdullah/repos | jq .
#  args: /repos/mohammed-abdullah/unified_automation_toolkit/actions/workflows | jq.
...
# Get a specific user:
    ...
    ${0##*/} /users/mohammed-abdullah


# List a user's GitHub repos:

    ${0##*/} /users/mohammed-abdullah/repos
...
# Get the GitHub Actions workflows for a given repo:
    ...
    ${0##*/} /repos/mohammed-abdullah/unified_automation_toolkit/actions/workflows
