...
#  args: mohammed-abdullah/spark-apps
#
...
See Also:
    ...
    https://github.com/mohammed-abdullah/Kubernetes-configs - for running GitHub Actions Runners in Kubernetes
"
...
docker run -ti \
           ...
           mohammed-abdullah/github-actions-runner \
