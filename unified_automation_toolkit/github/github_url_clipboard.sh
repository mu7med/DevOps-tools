...
Designed to quickly and easily copy link content into mohammed-abdullah/Knowledge-Base repo
eg. for mohammed-abdullah/SQL-scripts references to be easily copyable code blocks without having to follow links
