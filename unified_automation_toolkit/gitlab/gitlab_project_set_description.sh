...
Project can be the full project name (eg. mohammed-abdullah/unified_automation_toolkit) or the project ID
...
Example:
    ...
    ${0##*/} mohammed-abdullah/unified_automation_toolkit    my new description
