...
#
#   DOCKER_USER=mohammed-abdullah ./github_generate_status_docker.sh
#
...
#
#   DOCKER_USER=mohammed-abdullah ./github_generate_status_page.sh  mohammed-abdullah/hbase mohammed-abdullah/zookeeper mohammed-abdullah/nagios-plugins ...
#
#   DOCKER_USER=mohammed-abdullah ./github_generate_status_page.sh  hbase zookeeper nagios-plugins ...
...
if [ -z "$repolist" ]; then
    repolist="$(dockerhub_search.py -n 100 mohammed-abdullah | awk '/^mohammed-abdullah\/.*[[:space:]]\[OK]/{print $1}' | sort)"
fi
...
generated by \`${0##*/}\` in [mohammed-abdullah/unified_automation_toolkit](https://github.com/mohammed-abdullah/unified_automation_toolkit)
