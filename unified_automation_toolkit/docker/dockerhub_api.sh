...
#  args: /repositories/mohammed-abdullah/hbase/tags | jq .
#
...
# Get all the tags for a given repository called 'mohammed-abdullah/hbase':

    ${0##*/} /repositories/mohammed-abdullah/hbase/tags
"
