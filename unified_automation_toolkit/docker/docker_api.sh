...
#  args: https://hub.docker.com/v2/repositories/mohammed-abdullah/hbase/tags | jq .
#
...
# Get all the tags for a given repository called 'mohammed-abdullah/hbase' on DockerHub's public registry:

    ${0##*/} https://hub.docker.com/v2/repositories/mohammed-abdullah/hbase/tags
